...
<div class="<?php echo 'mod_'.$module->name.$moduleclass_sfx ?> alternative">
	<p class="template_msg"><strong><?php echo JText::_('MOD_HELLOWORLD_ALTERNATIVE_TEMPLATE_MSG'); ?></strong></p>
